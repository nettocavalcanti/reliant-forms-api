...
class Api::V1::FormSpecsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create form_spec" do
    assert_difference('FormSpec.count') do
      post "/api/v1/forms/#{@form_spec.form_id}/specs", params: { form_spec: { spec: "{\"key\":{\"type\":\"text\",\"mutable\":false,\"default\":\"static_key\"},\"value\":{\"type\":\"text\",\"mutable\":true}}" } }, as: :json
    end
  ...
  test "should update form_spec" do
    patch "/api/v1/forms/#{@form_spec.form_id}/specs/#{@form_spec.id}", params: { form_spec: { spec: "{\"key\":{\"type\":\"text\",\"mutable\":false,\"default\":\"static_key\"},\"value\":{\"type\":\"text\",\"mutable\":true}}" } }, as: :json
    assert_response 200
  end
